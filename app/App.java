package br.uft.edu.uft2023.Projeto1.CadastroUsuario.app;

import javax.swing.JOptionPane;

import br.uft.edu.uft2023.Projeto1.CadastroCliente.dao.ClienteMapDAO;
import br.uft.edu.uft2023.Projeto1.CadastroCliente.dao.IClienteDAO;
...
public class App {
    ...
    private static void consultar(String dados) {
        ...
        Usuario usuario = iUsuarioeDAO.consultar(Long.parseLong(dados));
        if (usuario != null) {
            JOptionPane.showMessageDialog(null, "Usuario encontrado: " + Usuario.toString(), "Sucesso",JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    private static void cadastrar(String dados) {
        ...
        Usuario usuario = new Usuario(dadosSeparados[0],dadosSeparados[1],dadosSeparados[2],dadosSeparados[3],dadosSeparados[4],dadosSeparados[5],dadosSeparados[6]);
        ...
        if (isCadastrado) {
            ...
            JOptionPane.showMessageDialog(null, "Usuario já se encontra cadastrado", "Erro",JOptionPane.INFORMATION_MESSAGE);
        }
    }
